...
export default class LWC01_NewTreaty extends NavigationMixin(LightningElement) {
    ...
    cessionShareEmpty = false; //RRA - ticekt 1966 - 14032024
    ...
    connectedCallback(){
        ...
        console.log ('isPlacementShareVisible', this.isPlacementShareVisible);
        console.log ('isCessionShareVisible', this.isCessionShareVisible);
        ...
        if(this.isTreatyCopy == true || this.isTreatyEdit == true){
            ...
            if(this.selectedTreaty == 'AXA SA QS'){ //RRA - ticket 1972 - 27032024
    ...
    handleSaveTreaty(){
        ...
        || (this.objTreaty.TECH_LTA__c == '1' && this.objTreaty.LTAPattern__c == '')){
            this.dispatchEvent(new ShowToastEvent({title: 'ERROR22', message:this.label.Required_Fields, variant: 'error'}),);
            ...
            checkTreatyName({ treatyId : this.selectedTreatyId, programId : this.programId, treatyName : dataInput.TreatyName.trim(), isTreatyCopy : this.isTreatyCopy})
                ...
                if(result == true){
                    ...
                    if(this.objTreaty.IsPooled__c == '1' && (this.dataPools == undefined || this.dataPools.length == 0)){
                        ...
                        //AMI 31/05/22 : W-1098
                        //Conditions - Blocage de la BR des champs Cocession
                        //adding precision param to cater to decimal places
                        if(sumCession.toPrecision(6) != 100){
                            this.dispatchEvent(new ShowToastEvent({title: 'Error55', message: this.label.cocessionFieldsTotal, variant: 'error' }),);
                            this.spinnerTreaty = false;
                        }
                        else{
                            ...
                            if(allValid){
                                ...
                                .then(result => {
                                    ...
                                    if(result.hasOwnProperty('Error') && result.Error){
                                        this.dispatchEvent(new ShowToastEvent({title: 'Error66', message: result.Error, variant: 'error' }),);
                                        this.spinnerTreaty = false;
                                    }else{
                                ...
                                this.dispatchEvent(new ShowToastEvent({title: 'Error77', message: this.label.FormEntriesInvalid, variant: 'error'}), );
                                this.spinnerTreaty = false;
                            }
                        }
                    }
